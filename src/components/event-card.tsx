    ...
    <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
      ...
      <CardContent className="p-4 flex-grow">
        <Link href={`/events/${event.id}`}>
          <CardTitle className="text-xl mb-2 hover:text-primary transition-colors">{event.name}</CardTitle>
        </Link>
        ...
        <div className="space-y-2 text-sm text-foreground">
          ...
          <div className="flex items-center">
           ...
           {event.distance && (
            <div className="flex items-center">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 mr-2 text-primary"><path d="M4 10c0 4.4 4 8 8 8s8-3.6 8-8c0-4.4-4-8-8-8s-8 3.6-8 8Z"/><path d="M16 10c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4 4 1.8 4 4Z"/><path d="M12 2v3"/><path d="M12 20v-3"/><path d="m6.4 7.4-.8-.8"/><path d="m18.4 16.4-.8-.8"/><path d="M4 12H1"/><path d="M23 12h-3"/><path d="m6.4 16.6.8-.8"/><path d="m18.4 7.6.8-.8"/></svg>
